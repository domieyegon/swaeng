...
my $MOSES      = '/home/d0mie/mosesSMT/Baseline/working/mert-work/moses';
my $MOSES_INI  = '/home/d0mie/mosesSMT/Baseline/working/binarised-model/moses.ini';


die "usage: daemon.pl 127.0.0.1 8181 <ini>" unless (@ARGV == 2);
